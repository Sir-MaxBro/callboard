...
{
    internal class KindSqlRepository : SqlProvider<Kind>, IKindRepository
    {
        public KindSqlRepository(ISqlDataProvider<Kind> sqlProvider, ILoggerWrapper logger, IChecker checker) 
