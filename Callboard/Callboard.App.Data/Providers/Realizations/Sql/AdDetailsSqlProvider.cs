...
{
    internal class AdDetailsSqlProvider : SqlProvider<AdDetails>, IAdDetailsProvider
    {
        public AdDetailsSqlProvider(ISqlDataProvider<AdDetails> sqlProvider, ILoggerWrapper logger, IChecker checker)
